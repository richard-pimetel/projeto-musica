...
const SUCCESS_CREATED_ITEM = {status: true, status_code: 201, message: 'Iem criado com sucesso!!!'}
const SUCCESS_DELETE_ITEM = {status: true, status_code: 200, message: 'Iem excluído com sucesso!!!'}
const SUCCESS_UPDATED_ITEM = {status: true, status_code: 200, message: 'Iem atualizado com sucesso!!!'}
module.exports = {
